	...
	protected void internalExecute() {
		...
		builder.setPositiveButton(R.string.OK, new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				Controller.getInstance().getAddonManager().onUserInput(mContext, mWebView, mAddon, mAddonAction.getId(), false, mInput.getText().toString());
			}
		});
		...
		builder.setNegativeButton(R.string.Cancel, new OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				Controller.getInstance().getAddonManager().onUserInput(mContext, mWebView, mAddon, mAddonAction.getId(), true, null);
			}
		});
