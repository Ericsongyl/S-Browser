...
public class TabView extends LinearLayout {
	...
	private void init(Context context) {
		...
		tabSelect = (ImageView) findViewById(R.id.tab_select);
	...
	private void updateTitle() {
		...
		if (mSelected) {
			tabSelect.setImageResource(R.drawable.item_current_selected);
		} else {
			tabSelect.setImageResource(R.drawable.item_choice_nor);
		}
	}
