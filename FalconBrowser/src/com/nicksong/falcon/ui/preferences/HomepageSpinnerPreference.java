...
public class HomepageSpinnerPreference extends BaseSpinnerPreference {
	...
	protected void setSpinnerValueFromPreferences() {
		String currentHomepage = PreferenceManager.getDefaultSharedPreferences(getContext()).getString(Constants.PREFERENCE_HOME_PAGE,
	...
	protected void onSpinnerItemSelected(int position) {
		...
		case 2:
			...
			if ((mEditText.getText().toString().equals(Constants.URL_ABOUT_START)) || (mEditText.getText().toString().equals(Constants.URL_ABOUT_BLANK))) {
