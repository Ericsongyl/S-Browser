...
import com.nicksong.falcon.model.HistoryAdapter;
...
public class HistoryFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		if (mContainer == null) {
			...
			mAdapter = new HistoryAdapter(getActivity(), mBookmarkStarChangeListener, getActivity().getResources().getInteger(R.integer.favicon_size));
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		if (selectedItem != null) {
			...
			List<AddonMenuItem> addonsContributions = Controller.getInstance().getAddonManager()
					.getContributedHistoryContextMenuItems(mUIManager.getCurrentWebView());
	...
	public boolean onContextItemSelected(MenuItem menuItem) {
		...
		if (selectedItem != null) {
			...
			case CONTEXT_MENU_COPY_URL:
				if (selectedItem != null) {
					ApplicationUtils.copyTextToClipboard(getActivity(), selectedItem.getUrl(),
							getActivity().getResources().getString(R.string.UrlCopyToastMessage));
				}
			...
			default:
				if (Controller
						.getInstance()
						.getAddonManager()
						.onContributedHistoryContextMenuItemSelected(getActivity(), menuItem.getItemId(), selectedItem.getTitle(), selectedItem.getUrl(),
