...
package com.nicksong.falcon.ui.components;
...
import com.nicksong.falcon.providers.SslExceptionsWrapper;
import com.nicksong.falcon.ui.managers.UIManager;

public class CustomWebViewClient extends WebViewClient {

	private static final Pattern ACCEPTED_URI_SCHEMA = Pattern.compile("(?i)" + // switch on case insensitive matching
	...
	public void onReceivedSslError(final WebView view, final SslErrorHandler handler, SslError error) {
		...
		if (hasAuthority) {
			...
			case SslExceptionsWrapper.AUTHORITY_ALLOWED:
				askUser = false;
				handler.proceed();
				Toast.makeText(view.getContext(), String.format(view.getResources().getString(R.string.SslExceptionAccessAllowedByUserToast), authority),
			...
			case SslExceptionsWrapper.AUTHORITY_DISALLOWED:
				askUser = false;
				handler.cancel();
				Toast.makeText(view.getContext(), String.format(view.getResources().getString(R.string.SslExceptionAccessDisallowedByUserToast), authority),
						Toast.LENGTH_SHORT).show();
				break;
	...
	public void onReceivedHttpAuthRequest(WebView view, final HttpAuthHandler handler, final String host, final String realm) {
		...
		if (username != null && password != null) {
			...
			AlertDialog dialog = new AlertDialog.Builder(mUIManager.getMainActivity())
					...
					.setIcon(android.R.drawable.ic_dialog_alert).setView(v).setPositiveButton(R.string.Proceed, new DialogInterface.OnClickListener() {
	...
	public void onFormResubmission(WebView view, Message dontResend, Message resend) {
		...
		new AlertDialog.Builder(mUIManager.getMainActivity()).setTitle(R.string.FormResubmitTitle).setMessage(R.string.FormResubmitMessage)
