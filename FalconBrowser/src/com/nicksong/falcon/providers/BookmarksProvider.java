...
public class BookmarksProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.nicksong.falcon.providers.bookmarksprovider";
	...
	private static final String BOOKMARKS_TABLE_CREATE = "CREATE TABLE " + BOOKMARKS_TABLE + " (" + Columns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
			+ Columns.TITLE + " TEXT, " + Columns.URL + " TEXT, " + Columns.VISITS + " INTEGER, " + Columns.CREATION_DATE + " LONG, " + Columns.VISITED_DATE
			+ " LONG, " + Columns.BOOKMARK + " INTEGER, " + Columns.IS_FOLDER + " INTEGER NOT NULL DEFAULT 0, " + Columns.PARENT_FOLDER_ID
			+ " INTEGER NOT NULL DEFAULT -1, " + Columns.FAVICON + " BLOB DEFAULT NULL, " + Columns.THUMBNAIL + " BLOB DEFAULT NULL);";
	...
	public int bulkInsert(Uri uri, ContentValues[] values) {
		...
		case BOOKMARKS:
			...
			try {
				...
				SQLiteStatement insert = mDb.compileStatement("INSERT INTO " + BOOKMARKS_TABLE + "(" + Columns.TITLE + ", " + Columns.URL + ", "
						+ Columns.VISITS + ", " + Columns.CREATION_DATE + ", " + Columns.VISITED_DATE + ", " + Columns.BOOKMARK + ", " + Columns.IS_FOLDER
						+ ", " + Columns.PARENT_FOLDER_ID + ") VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
