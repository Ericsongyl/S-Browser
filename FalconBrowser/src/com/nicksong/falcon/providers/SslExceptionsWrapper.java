...
public class SslExceptionsWrapper {
	...
	public static String[] SSL_EXCEPTIONS_PROJECTION = new String[] { SslExceptionsProvider.Columns._ID, SslExceptionsProvider.Columns.AUTHORITY,
			SslExceptionsProvider.Columns.REASON, SslExceptionsProvider.Columns.ALLOW };
