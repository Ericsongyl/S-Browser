...
public class SslExceptionsProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.nicksong.falcon.providers.sslexceptionsprovider";
	...
	private static final String SSL_EXCEPTION_TABLE_CREATE = "CREATE TABLE " + SSL_EXCEPTIONS_TABLE + " (" + Columns._ID
			+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + Columns.AUTHORITY + " TEXT NOT NULL, " + Columns.REASON + " INTEGER NOT NULL DEFAULT 0, "
